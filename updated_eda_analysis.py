...
def plot_merged_scatter(merged: pd.DataFrame) -> None:
    ...
    plt.close()
    print("\nFigure 7 Caption:")
    print("Scatter plot showing the relationship between annual mean PM2.5 concentration and asthma prevalence across 31 Washington counties. The correlation coefficient is r = -0.076, indicating no significant linear relationship between PM2.5 exposure and asthma prevalence in Washington State in 2022.")
